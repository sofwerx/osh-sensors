...
package org.sensorhub.test.sensor.plume;
...
public class TestPlumeDriver implements IEventListener
{
    PlumeSensor driver;
    PlumeConfig config;	
    ...
    public void init() throws Exception
    {
        ...
        config.dataPath = "C:/Data/sensorhub/plume/20151214/PARTICLE.OUT_12Zrel_350m";
    ...
    {
        System.out.println();
        ISensorDataInterface output = driver.getObservationOutputs().get("plumeModel");
